...
My_Theme <- theme(
  axis.title.x = element_text(size = 16), #x axis title label
  axis.text = element_text(size = 15), # x and y axis labels
  legend.text = element_text(size = 15), # legend contents labels
  legend.title = element_text(size = 16), # legend title label
  axis.title.y = element_text(size = 16)) # y axis title label
...
```{r carbohydrate plot, fig.height=4, fig.width=8, echo=FALSE}


ggplot(Cleaned_CEA_data, aes(Treatment, CHO ,  color = factor(Fiber_concentration))) +
  geom_boxplot() +
  labs(x = "Treatment", y = "Carbohydrate (mJ/mg)", color = "Fiber Concentration (fibers/ml)") +
...
```{r lipid plot, fig.height=4, fig.width=8, echo=FALSE}
ggplot(Cleaned_CEA_data, aes(Treatment, LIP ,  color = factor(Fiber_concentration))) +
  geom_boxplot() +
  labs(x = "Treatment", y = "Lipid (mJ/mg)", color = "Fiber Concentration (fibers/ml)") +
  scale_x_discrete(limits = c("Baseline", "Control", "[Fiber 1]", "[Fiber 1] + PCB", "[Fiber 2]", "[Fiber 2] + PCB")) +
  My_Theme
```
...
```{r protein plot, fig.height=4, fig.width=8, echo=FALSE}
ggplot(Cleaned_CEA_data, aes(Treatment, PRT ,  color = factor(Fiber_concentration))) +
  geom_boxplot() +
  labs(x = "Treatment", y = "Protein (mJ/mg)", color = "Fiber Concentration (fibers/ml)") +
  scale_x_discrete(limits = c("Baseline", "Control", "[Fiber 1]", "[Fiber 1] + PCB", "[Fiber 2]", "[Fiber 2] + PCB")) +
  My_Theme
```
